...
function BottomBar({ coordinates, phone, style, onSave, isSelected }: Props) {
	...
	return (
		<View style={[styles.bottomBar, style]}>
			...
			>
				{isSelected ? (
					<>
						<AntDesign name="heart" size={24} color="#ED4337" />
						<Text style={styles.callButtonText}>UnSave</Text>
					</>
				) : (
					<>
